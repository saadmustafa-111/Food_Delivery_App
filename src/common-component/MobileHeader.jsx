...
const MobileHeader = ({ onclose }) => {
  return (
    <>
      <div className="w-full flex flex-col lg:hidden p-3 overflow-x-hidden">
      ...
      <div className="flex md:hidden overflow-x-hidden">
        <div className="flex gap-2 bg-orange-500 flex-1 p-3 items-center justify-center">
          <img src={img} alt="" />
          <p className="font-semibold">Saad </p>
        </div>
        <div className="flex gap-4 bg-green-600 flex-1 p-3 items-center justify-center">
          <div>
            <img src={basket} alt="" />
          </div>
          <div>
      ...
      <div className="md:hidden p-4 flex gap-4 justify-end items-center overflow-x-hidden">
        <div>
