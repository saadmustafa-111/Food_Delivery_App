...
function Cardcomp() {
  ...
  return (
    <div className=" w-full py-4 bg-gray-200 h-auto text-sm md:mx-5 rounded-lg relative">
      <div className="flex flex-col  relative z-20">
        <div className="mb-10 flex flex-col md:flex-row items-center text-lg">
          <p className="mt-20 ml-20 font-bold text-3xl">Know More About Us</p>
          <nav className="hidden mt-20 ml-auto font-bold md:flex space-x-4 items-center mr-20">
        ...
        <div className="  bg-slate-950 p-6 md:p-24 mt-4 my-10 md:my-20 mx-4 md:mx-20 rounded-lg relative">
