...
export default function Midcontainer() {
  return (
    <>
      <div className='py-4 bg-slate-950 h-auto text-sm mx-10 border-4 rounded-lg flex relative'>
        {/* Large Container for Text and Photos */}
        <div className="mx-10 mt-12 ml-14  text-white rounded-lg p-6">
          <h2 className="text-2xl mb-4">Order Restaurant food takeaway and groceries</h2>
      ...
      <div className='absolute inset-0 flex items-center justify-center flex-col'>
        <img src={group1} alt="Group 1" className=' flex items-center justify-center w-48 h-28 rounded-lg ' />
        <img src={group3} alt="Group 1" className=' flex items-center justify-center w-48 h-28 rounded-lg ' />
        <img src={group2} alt="Group 1" className=' flex items-center justify-center w-48 h-28 rounded-lg ' />
      </div>
    </div>
      </div>
